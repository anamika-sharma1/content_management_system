...
$DateTime=strftime("%B-%d-%Y %H:%M:%S", $CurrentTime);
  ...
  elseif (strlen($PostDescription)>999) {
    ...
    global $conn;
    $sql="update posts set datetime=:dateTime, category=:categoryName,author=:authorName,image=:imageName,post=:postDescription where id=$SearchQueryParameter;";
    ...
    if($Execute){
      $_SESSION["SuccessMessage"]="Post Title with id : " . $conn->lastInsertId() . " updated successfully.";
      Redirect_to("updatepost.php");
    }
    else{
  ...
  <div class="row" style="height:10px;">
    ...
    ?>
      ...
      <div class="card-header bg-secondary">
        <span style="font-size:2em; font-family:Merriweather; color:white;">Update Post</span>
      </div>
