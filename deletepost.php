...
<?php if(isset($_POST['submit'])){
  ...
  elseif (strlen($PostTitle)>49) {
    ...
    if($Execute){
      $_SESSION["SuccessMessage"]="Post Title with id : " . $conn->lastInsertId() . " deleted successfully.";
      Redirect_to("deletepost.php");
    }
    else{
  ...
  <div class="row" style="height:10px;">
    <div class="offset-lg-2 col-lg-8" style="height:10px;">
      ...
      <div class="card-header bg-secondary">
        <span style="font-size:2em; font-family:Merriweather; color:white;">Delete Post</span>
      </div>
